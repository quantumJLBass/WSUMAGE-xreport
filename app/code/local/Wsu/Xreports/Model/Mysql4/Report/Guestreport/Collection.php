...
class Wsu_Xreports_Model_Mysql4_Report_Guestreport_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function __construct() {
        ...
        $this->_resource = Mage::getResourceModel('xreports/guestreport')->init('xreports/guestreport');
