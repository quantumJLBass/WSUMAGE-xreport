...
class Wsu_Xreports_Model_Mysql4_Report_Salesbynewandreturning_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function __construct() {
        ...
        $this->_resource = Mage::getResourceModel('xreports/salesbynewandreturning')->init('xreports/salesbynewandreturning');
     ...
     *
     * @return Wsu_Xreports_Model_Mysql4_Report_Salesbydayofweek_Collection
     */
     ...
     * @return boolean|Wsu_Xreports_Model_Mysql4_Report_Salesbydayofweek_Collection
     */
