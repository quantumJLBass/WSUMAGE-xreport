...
class Wsu_Xreports_Model_Mysql4_Report_Salesbyhour_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
    ...
    public function __construct() {
        ...
        $this->_resource = Mage::getResourceModel('xreports/salesbyhour')->init('xreports/salesbyhour');
     ...
     *
     * @return Wsu_Xreports_Model_Mysql4_Report_Salesbyhour_Collection
     */
    ...
    protected function _initSelect() {
        ...
        if (!$this->isTotals()) {
            //$this->getSelect()->joinRight('xreports_hour', 'HOUR(sales_flat_order.created_at) = xreports_hour.h', array('h'));            
     ...
     * @return boolean|Wsu_Xreports_Model_Mysql4_Report_Salesbyhour_Collection
     */
