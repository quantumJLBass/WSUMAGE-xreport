...
class Wsu_Xreports_Block_Adminhtml_Report_Salesbyproduct_Filter_Form extends Mage_Adminhtml_Block_Widget_Form {
    ...
    protected function _prepareForm() {
        ...
        $fieldset->addField('sku', 'text', array(
            'label' => Mage::helper('xreports')->__('Search SKU'),
            'title' => Mage::helper('xreports')->__('Enter SKU for report'),
