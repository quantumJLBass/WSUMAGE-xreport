...
class Wsu_Xreports_Block_Adminhtml_Report_Salesbycustomergroup extends Mage_Adminhtml_Block_Widget_Grid_Container {

    public function __construct() {
        $this->_blockGroup = 'xreports';
        $this->_controller = 'adminhtml_report_salesbycustomergroup';
        $this->_headerText = Mage::helper('xreports')->__('Sales by Customer Group');
        $this->setTemplate('wsu/xreports/report/salesbycustomergroup/grid/container.phtml');
        parent::__construct();
